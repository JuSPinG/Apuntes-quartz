#!/bin/bash
# ---------------------------------------------------------------
# CCN-STIC-610 - Opciones de Seguridad y Hardening en OpenSUSE
# ---------------------------------------------------------------
...
# Para relajar la seguridad, se podría poner un:
...
# Inactividad
#--------------------------
log_info "Estableciendo límite de inactividad de sesión (600s)..."
...
#--------------------------
log_info "Aplicando política criptográfica FUTURE..."
